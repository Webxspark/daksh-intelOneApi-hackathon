    ...
    <div className="App">
      {currentAccount === "" ? (
            ...
            <div className="grid grid-cols-12">
              <div className="lg:h-[80dvh] h-auto flex flex-col justify-center col-span-12 md:col-span-5 md:order-1 order-2">
                <div className="mx-3 lg:mx-12">
                  <div className="text-4xl font-bold">EmergAI</div>
                  <div className="my-6">
        ...
        >
          ...
          ></img>
          <div>-----------------------------------------</div>
          <div>Looks Like You are not WhiteListed, Only authorised <b>EmergAI</b> Team Members are allowed to access this page.</div>
